...
<style>
    ...
    input[type="number"] {
        background-color: #1F1147 !important;
        color: #FAFAFA !important;
        -webkit-text-fill-color: #FAFAFA !important; /* THIS IS THE MAGIC FIX */
        caret-color: #FAFAFA !important; /* Makes the typing cursor white */
    }
...
with tab2:
    ...
    if search_user:
        ...
        if not db_loaded:
            st.info("ℹ️ Running in local demo mode. Cloud database history is currently offline.")
